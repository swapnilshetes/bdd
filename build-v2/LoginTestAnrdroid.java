...
public class LoginTestAnrdroid {
	...
	public void deviceSetUp(String device, String app_package, String activity, String version, String appiumServer , int port, String dvudid)
		...
		appiumService=AppiumDriverLocalService.buildService( new AppiumServiceBuilder().usingPort(port));
		...
		// Set job name
		driver = new AndroidDriver<MobileElement>(new URL(appiumServiceUrl), caps);
